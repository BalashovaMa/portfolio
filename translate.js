...
const getTranslate = (lang) => {
    dictionary.forEach((element) => { element.textContent = i18Obj[lang][element.dataset.i18] }
    )
}
const langBtns = document.querySelectorAll('.lng');
const langBtn = document.querySelector('.lng');
